...
namespace SampleWebsite.Areas.UserAdministration.Controllers
{
	...
	public class UserAdministrationController : Controller
	{
        ...
        private const string ResetPasswordFromAddress = "admin@smchsg.com";
		...
		{
			SMCHSGManager.Controllers.OrdinaryMemberController mic = new SMCHSGManager.Controllers.OrdinaryMemberController();
			mic.DeleteUser(id);

            //_userService.Delete(_userService.Get(id), true);
			//return RedirectToAction("Index");

			return RedirectToAction("List", "MemberInfo", new { Area = "", initiateOnly = false });
		}
