...
--%>            
			...
			<table  align="left"   border="1" width = 100%  style ="border-color:Lime; background-color: #FED36B; border-bottom-style:groove">
                    ...
                    <tr>
						...
						<td ><%: Html.DropDownList("LocalRetreatScheduleOffsetID", new SelectList(ViewData["LocalRetreatScheduleOffsets"] as IEnumerable, "ID", "OffsetHours", Model.ScheduleOffsetID))%>  </td>
					</tr>
                    <%}
                      else
                      {%>
