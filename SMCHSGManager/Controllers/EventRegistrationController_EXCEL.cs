...
namespace SMCHSGManager.Controllers
{
    public class EventRegistrationController : Controller
    {
		...
		public string[][] GetStringList()
		{
            ...
            if (((List<string>)TempData["mLabels"]).Count == 0)
            {
                headList = new string[][]
			    {
			    	new string[] {"S/N", "Name in ID Card", "Member No", "ID Card No", "Contact No", "Volunteer Job", "To Pay"},
                    new string[] {},
                    new string[] {},
			    };
            }
        ...
        private void GetMealNameDate(int localRetreatID, out List<string> mealNameDates, out List<string> mealNameDateValues, bool meal)
        {
            ...
            var tMealNameDates = from a in _entities.EventPrices
                                 ...
                                 select a;
            if (tMealNameDates != null && tMealNameDates.Count() > 0)
            {
